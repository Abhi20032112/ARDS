  ...
  const projects = [
    {
      ...
      image: 'Modern e-commerce website design with vibrant product displays and clean interface',
    ...
    },
    {
      ...
      image: 'Innovative tech startup office with modern workspace and digital screens showing analytics',
    ...
    },
    {
      ...
      image: 'Elegant restaurant interior with modern branding and sophisticated dining atmosphere',
    ...
    },
    {
      ...
      image: 'Modern healthcare facility with professional staff and clean, welcoming environment',
    ...
    },
    {
      ...
      image: 'Stylish fashion photoshoot with models wearing trendy clothing in urban setting',
    ...
    },
    {
      ...
      image: 'Luxury real estate property with modern architecture and beautiful landscaping',
                ...
                <AnimatePresence mode="wait">
                  ...
                  >
                    <div className="relative h-80 lg:h-auto">
                      <img  class="w-full h-full object-cover" alt={projects[currentSlide].title} src="https://images.unsplash.com/photo-1572177812156-58036aae439c" />
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <motion.div {...fadeIn} className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Browse through our complete portfolio of successful digital marketing projects.
              </p>
            </motion.div>
              ...
              {projects.map((project, index) => (
                ...
                >
                  <div className="relative h-56">
                    <img  class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-400" alt={project.title} src="https://images.unsplash.com/photo-1572177812156-58036aae439c" />
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <motion.div {...fadeIn} className="text-white space-y-8">
              ...
              <p className="text-lg text-white/90 max-w-2xl mx-auto">
                Let's work together to create the next amazing project that showcases your brand's potential.
              </p>
