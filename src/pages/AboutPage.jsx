...
const AboutPage = () => {
  ...
  const teamMembers = [
    { name: "Vikrant Mishra", role: "", image: "" },
    { name: "Abhijeet M Mishra", role: "", image: "" },
  ];
        ...
        <section className="py-24">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <motion.div {...fadeIn}>
                <h2 className="text-3xl lg:text-4xl font-extrabold gradient-text mb-6">The Story Behind Our Success</h2>
                <p className="text-lg text-gray-600 mb-4 leading-relaxed">
                  Alpenrose Digital Solutions was founded with a simple yet powerful belief: every business deserves a digital presence that is as unique and ambitious as its vision. We started as a small team of innovators and storytellers, united by a passion for technology and a desire to make a real impact.
                </p>
                <p className="text-lg text-gray-600 leading-relaxed">
                  Today, we are a full-service digital marketing agency that has helped hundreds of clients achieve their goals. Our journey is defined by a relentless pursuit of excellence, a commitment to our clients, and a culture of continuous innovation.
                </p>
              </motion.div>
              <motion.div {...fadeIn} transition={{...fadeIn.transition, delay: 0.2}} className="h-96">
                <img  class="w-full h-full object-cover rounded-3xl shadow-xl" alt="A team of professionals collaborating in a modern office" src="https://images.unsplash.com/photo-1573165231977-3f0e27806045" />
              </motion.div>
            </div>
          </div>
        </section>
              ...
              {teamMembers.map((member, index) => (
                ...
                >
                  <div className="relative w-32 h-32 mx-auto mb-4">
                    <img  class="w-full h-full rounded-full object-cover shadow-lg" alt={member.name} src="https://images.unsplash.com/photo-1595872018818-97555653a011" />
