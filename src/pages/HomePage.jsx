            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              >
                <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold leading-tight">
                  We Grow Your Brand <br className="hidden sm:block"/> Like It's Our Own
                </h1>
              ...
              >
                <div className="floating-animation">
                  <img  class="w-full h-auto rounded-3xl shadow-2xl" alt="Digital marketing team collaborating on a futuristic interface" src="https://images.unsplash.com/photo-1625296276703-3fbc924f07b5" />
                </div>
              </motion.div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {metrics.map((metric, index) => (
                ...
                >
                  ...
                  <h3 className="text-5xl font-extrabold gradient-text mb-2">{metric.value}</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {features.map((feature, index) => (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  className="bg-gray-50 p-8 rounded-3xl shadow-lg card-hover border border-gray-200/50"
                >
